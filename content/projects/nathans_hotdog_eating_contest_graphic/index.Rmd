...
hot_dogs <- read_csv("content/projects/nathans_hotdog_eating_contest_graphic/hot_dog_contest.csv", col_types = cols(
...
```{r load data w fem, eval=FALSE, include=TRUE}
hdm_females <- read_csv("content/projects/nathans_hotdog_eating_contest_graphic/hot_dog_contest_with_affiliation.csv", 
    col_types = cols(
